...
public class ContatoController : ControllerBase
{
    ...
    {
        if (string.IsNullOrWhiteSpace(novoContato.Nome) && novoContato.DadosContato != null)
        ...
        contato.DadosContato = novoContato.DadosContato!;
        contato.IdTipoContato = novoContato.Id_tipoContato;
